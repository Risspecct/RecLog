...
from app.models.simulation import SimulationDashboardRequest, SimulationDashboardResponse, ScenarioResultResponse
from app.services.simulation_service import get_hotspot_for_simulation, scenario_dashboard
